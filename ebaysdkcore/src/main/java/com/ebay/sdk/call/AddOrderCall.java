 ...
 * <br> <B>Output property:</B> <code>ReturnedOrderID</code> - The unique identifier for the Combined Payment order. This value is created by eBay upon a successful <b>AddOrder</b> call. This value can be used as an input filter in <a href="../GetOrders.html">GetOrders</a> and <a href="../GetOrderTransactions.html">GetOrderTransactions</a> to retrieve the order.
 * <br> <B>Output property:</B> <code>ReturnedCreatedTime</code> - Timestamp that indicates the date and time that the Combined Payment order was created.
 * 
 * @author Ron Murphy
 * @version 1.0
 */
